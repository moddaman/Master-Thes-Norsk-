...
\begin{figure}[ht!]
\centering
\includegraphics[width=140mm]{netframework4.5}
...
Rapporten har som mål å undersøke potensielle forbedringer noen utvalgte funksjoner (beskrevet i kap) kan ha på den eksisterende løsningen Tobii Sono Flex (\ref{chap:Tobii-Sono-Flex}). Det mest naturlige valget med henhold til utvikling, ville vært å ta utgangspunkt i eksisterende kildekode og utvidet med nødvendig kode. Problemet var at plattformen som den eksisterende koden var bygget på begynte å bli utdatert og ville gjort det vanskelig å fått implementert mye av funksjonalitet som skulle undersøkes. Hovedsaklig animasjonene. Resultatet var at utviklingen ble startet med et nytt prosjekt. Slik at første del av utviklingen var å lage en simplifisert prototype av den samme applikasjonen bare på en en annen plattform.

\section{Plattform}

Valget av plattform baserte seg på at det måtte være tilrettelagt for implementering av ønsket funksjonalitet, altså god støtte for brukergrensesnitt teknologi som animasjon, lyd og bildebruk. En annen viktig faktor var at rammeverket måtte være kompatibelt med øyestyringsenheten. Plattformen som best oppfulgte disse kravene var .net rammeverket til microsoft.  Rammeverket er omfattende og kan skilte med opptil flere programmeringspråk og komponenter. Rapporten vil derimot kun gi informasjon om de ulike komponentene fra .net som ble brukt og er nødvendig for videre lesning.
